    ...
    <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm">
          ...
          <span>{INFO_POUSADA.endereco}, {INFO_POUSADA.cidade}</span>
        </div>

        {/* Título principal */}
        <div className="mb-4 flex items-center justify-center gap-3">
          <GraduationCap className="h-10 w-10 text-secundaria-400 sm:h-12 sm:w-12" />
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-secundaria-500 px-7 py-4 text-base font-semibold text-white shadow-lg transition-all hover:bg-secundaria-600 active:scale-95"
        >
          Ver Acomodações
